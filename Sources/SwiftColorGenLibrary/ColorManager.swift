...
public struct ColorManager {
    ...
    public static func resetColors(xml: AEXMLElement, assets: [Asset]) {
    ...
    public static func updateColors(xml: AEXMLElement, colors: Set<ColorData>) {
    ...
    public static func getColorsForGenerator(colors: Set<ColorData>) -> [(color: ColorData,
                                                                   assetName: String,
                                                                   outputName: String,
